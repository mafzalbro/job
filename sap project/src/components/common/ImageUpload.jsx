    ...
    <div className="flex flex-col items-center gap-4">
      {preview && (
        <img
          ...
          style={{
            filter: `drop-shadow(0px 0px 1px rgba(255, 255, 255, 0.5)) invert(${
              isInvertedRequired ? 1 : 0
            })`, // Adds a drop shadow
          }}
        />
      )}
      <label
        htmlFor="file-upload"
        className={`cursor-pointer px-4 py-2 text-sm font-medium !text-background !bg-text rounded hover:shadow-lg ${
