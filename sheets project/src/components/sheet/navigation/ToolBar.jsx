      ...
      >
        {tools.map((tool, index) => (
          <div key={index} className="group">
            ...
            <span className="absolute top-10 z-[1000] select-none pointer-events-none transform -translate-x-1/2 px-2 py-1 bg-text text-white text-center rounded opacity-0 group-hover:opacity-100 transition text-xs">
              {tool.tooltip}
            </span>
          </div>
        ))}
